...
<p align="center">
  <sub>Last updated: 2026-04-22 · Synced to v7.9.7 (source of truth: <a href="CHANGELOG.md">CHANGELOG</a> + code)</sub>
</p>
...
### Latest (v7.9.7 · 2026-04-22)

- 👀 Video detail pages can show the current viewer count, with an Appearance toggle.
- 🔎 Search discovery now prioritizes recent-search suggestions and followed creators before generic trends.
- 🏠 Home recommendations can hide cover duration badges to reduce visual clutter.
- 📺 Added the live UI alignment design notes for later merge and verification work.
