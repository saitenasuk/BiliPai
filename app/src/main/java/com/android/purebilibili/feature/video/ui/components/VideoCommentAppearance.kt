...
internal data class VideoCommentAppearance(
    ...
    val segmentedBackgroundColor: Color,
    val segmentedIndicatorColor: Color,
    val segmentedSelectedTextColor: Color,
    val segmentedUnselectedTextColor: Color,
...
internal fun resolveVideoCommentAppearance(
    ...
    return VideoCommentAppearance(
        ...
        segmentedBackgroundColor = surfaceVariantColor.copy(alpha = 0.50f),
        segmentedIndicatorColor = surfaceColor,
        segmentedSelectedTextColor = onSurfaceColor,
        segmentedUnselectedTextColor = onSurfaceVariantColor,
